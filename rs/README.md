...
Building neon-app requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
After building neon-app, you can explore its exports at the Node console:
